...
class ImageMessageTile extends BaseMessageTile {
  ...
  @override
  ConsumerState<ImageMessageTile> createState() => _ImageMessageTileState();
}

class _ImageMessageTileState extends BaseMessageTileState<ImageMessageTile> {
  @override
  ...
  Widget _buildImageGrid() {
    final imageMessage = widget.message as ImageMessageData;
    final images = imageMessage.imageData;
    ...
    return Column(
      ...
      children: [
        Text("${widget.message.username}:", style: Theme.of(context).textTheme.bodyLarge),
        SizedBox(height: 8),
        if (widget.message.content != null && widget.message.content!.isNotEmpty)
          Padding(
            padding: EdgeInsets.only(bottom: 8),
            child: Text(widget.message.content!, style: Theme.of(context).textTheme.bodyMedium),
          ),
        // Images grid
        Builder(
          builder: (context) {
